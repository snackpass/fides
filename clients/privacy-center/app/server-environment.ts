  ...
  actions: [
    {
      ...
      description:
        "We will send you a copy of all of your personal data within 45 days.",
      identity_inputs: {
        name: "required",
        phone: "required",
      },
    },
    {
      ...
      description:
        "We will delete your account and all of its associated data within 45 days. THIS ACTION CANNOT BE UNDONE: your account, rewards, punchcard points, etc. can never be recovered once deleted. You will have to make a new account if you wish to use Snackpass again.",
      identity_inputs: {
        name: "required",
        phone: "required",
      },
    ...
    consentOptions: [
      {
        ...
        description:
          "We may use some of your personal information for advertising performance analysis and audience modeling for ongoing advertising which may be interpreted as 'Data Sharing' under some regulations.",
      ...
      },
      {
        ...
        description:
          "We may use some of your personal information to collect analytics about how you use our products & services, in order to improve our service.",
